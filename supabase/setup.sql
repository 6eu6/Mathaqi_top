...
insert into public.mathaqi_settings (key, value) values
  ...
  ('signature', jsonb_build_object(
      'kicker', 'الطبق المميّز',
      'title', 'شاورما ع الفحم',
      'text', 'لحمٌ متبّل يُشوى على الفحم ببطء ليكتسب نكهته الدخانية العميقة، يُلفّ طازجاً مع الخضار والصوص الخاص. سرّ مذاقنا الذي يعود له الزبائن دائماً.',
      'from_price', 500
   )),
